 ...
 * 创建选择题数据请求DTO
 */
public class CreateChoiceQuestionDataRequest {
    ...
    // 构造函数
    public CreateChoiceQuestionDataRequest() {}
    
    public CreateChoiceQuestionDataRequest(String knowledgeId, String choiceType, Integer points, List<ChoiceOptionRequest> options) {
