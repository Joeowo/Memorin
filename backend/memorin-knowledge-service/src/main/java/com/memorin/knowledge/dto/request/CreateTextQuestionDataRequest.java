 ...
 * @since 2025-01-18
 */
public class CreateTextQuestionDataRequest {

    /**
     * 关联的知识点ID - 必须是已存在的text类型知识点
     */
    ...
    // 构造函数
    public CreateTextQuestionDataRequest() {}
    ...
    public String toString() {
        return "CreateTextQuestionDataRequest{" +
